var ReactNative = require('react-native'),
  ...
  module839 = {
    ARROW_DOWN: require('./836'),
    ARROW_UP: require('./837'),
    TICK: require('./838'),
    CLOSE: require('./839'),
  };

exports.ICONS = module839;
var l = ReactNative.StyleSheet.create({
  ...
  style: {
    ...
    paddingVertical: 3,
    backgroundColor: module835.default.WHITE,
  },
  label: {
    flex: 1,
    color: module835.default.BLACK,
  },
  labelContainer: {
    flex: 1,
    flexDirection: 'row',
  ...
  searchContainer: {
    ...
    alignItems: 'center',
    padding: 10,
    borderBottomColor: module835.default.BLACK,
    borderBottomWidth: 1,
  },
  searchTextInput: {
    flexGrow: 1,
  ...
  itemSeparator: {
    height: 1,
    backgroundColor: module835.default.BLACK,
  },
