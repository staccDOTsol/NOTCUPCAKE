...
var module940 = s(require('./940')),
  ...
  d = new ('function' != typeof TextDecoder ? module1005.TextDecoder : TextDecoder)('utf-8', {
    fatal: true,
  });
  ...
  try {
    if ('string' == typeof n) i['write' + m(n)](r);
      ...
      if ('number' == typeof n[0]) {
        ...
        if (r.length !== n[1]) throw new module59('Expecting byte array of length ' + n[1] + ', but got ' + r.length + ' bytes');

        for (var f = 0; f < n[1]; f++) U(e, null, r[f], n[0], i);
      } else
  ...
  try {
    ...
    if (r instanceof Array) {
      ...
      if ('number' == typeof r[1]) {
        for (var i = [], f = 0; f < r[1]; f++) i.push(B(e, null, r[0], n));

        return i;
      }

      return n.readArray(function () {
        return B(e, t, r[0], n);
      });
    }

    if ('option' === r.kind) return n.readU8() ? B(e, t, r.type, n) : undefined;

    if ('map' === r.kind) {
      for (var o = new Map(), u = n.readU32(), s = 0; s < u; s++) {
        var l = B(e, t, r.key, n),
          c = B(e, t, r.value, n);
        o.set(l, c);
      }
...
function A(t, r, n) {
  if ('function' == typeof r.borshDeserialize) return r.borshDeserialize(n);
  var i = t.get(r);
...
exports.serialize = function (e, t) {
  var r = new (arguments.length > 2 && undefined !== arguments[2] ? arguments[2] : module8)();
  k(e, t, r);
  return r.toArray();
};

exports.deserialize = function (e, t, r) {
  var n = new (arguments.length > 3 && undefined !== arguments[3] ? arguments[3] : module8)(r),
    i = A(e, t, n);
...
exports.deserializeUnchecked = function (e, t, r) {
  return A(e, t, new (arguments.length > 3 && undefined !== arguments[3] ? arguments[3] : module8)(r));
};
